    ...
    return e.prototype = {
        ...
        bindEvent: function() {
            function e(e) {
                ...
                d.gearArea.innerHTML = '<div class="area_ctrl slideInUp"><div class="area_btn_box"><div class="area_btn larea_cancel">取消</div><div class="area_btn larea_finish">确定</div></div><div class="area_roll_mask"><div class="area_roll"><div><div class="gear area_province" data-areatype="area_province"></div><div class="area_grid"></div></div><div><div class="gear area_city" data-areatype="area_city"></div><div class="area_grid"></div></div></div></div></div>',
            ...
            function i(e) {
                ...
                if(!a){ return}   //只是点击的话，t["new_" + t.id]是undefined，a就是NaN，会报错
        ...
        finish: function(e) {
            ...
            t.trigger.value = s + (c ? "," + c : "") ,
            t.value = [n, o, 0],
            this.valueTo && (this.valueTo.value = d + (v ? "," + v : "") ),
                t.close(e)
        },
        close: function(e) {
            e.preventDefault();
